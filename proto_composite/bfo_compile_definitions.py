...
## Level 4
con_entity_i_i_co_1 = con_entity_i_i_co.sub_entity.add();  con_entity_i_i_co_1.term   = 'Continuant fiat bounary 1d'
con_entity_i_i_co_2 = con_entity_i_i_co.sub_entity.add();  con_entity_i_i_co_2.term   = 'Continuant fiat bounary 2d'
con_entity_i_i_co_3 = con_entity_i_i_co.sub_entity.add();  con_entity_i_i_co_3.term   = 'Continuant fiat bounary 3d'
...
serialized = examplebfo.SerializeToString()
with open('proto_composite/compiled/bfo_defs_compiled.bin',"wb") as f:
    f.write(serialized)
